...
export function ExamQuestionCard({
  ...
  return (
    <div className='bg-white dark:bg-neutral-800 rounded shadow p-5 col-span-8'>
      <div className='mb-6 flex justify-between items-center gap-2'>
        ...
        <Button
          variant='ghost'
          size='sm'
          className={`ml-2 px-2 py-1 text-xs ${flagged.includes(current + 1) ? 'text-yellow-400' : 'text-gray-400'}`}
          onClick={onFlag}
        >
          <IoFlagOutline/>
        </Button>
