...
import type { CreateQuestionSetRequest, GetQuestionSetsResponse } from '@/lib/validations/lecturer/exams/question-set'
...
export const useCreateQuestionSet = () => {
  ...
  return useMutation({
    mutationFn: (data: CreateQuestionSetRequest) =>
      apiClient.post('/question-set', data),
    onSuccess: () => {
