      ...
      <div className='container mx-auto'>
        <FadeIn>
          <div className='text-center mb-8'>
            <h1 className='text-4xl font-bold text-gray-900 mb-4'>Form Examples</h1>
            ...
            <div className='bg-white rounded-lg shadow-lg p-6'>
              ...
              <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-3'>
                <div className='p-4 border rounded-lg'>
                  ...
                  <p className='text-sm text-gray-600'>Type-safe schema validation with comprehensive error handling</p>
                </div>
                <div className='p-4 border rounded-lg'>
                  <h3 className='font-semibold text-blue-600 mb-2'>✓ React Hook Form</h3>
                  <p className='text-sm text-gray-600'>Performant forms with minimal re-renders and great UX</p>
                </div>
                <div className='p-4 border rounded-lg'>
                  <h3 className='font-semibold text-purple-600 mb-2'>✓ shadcn/ui</h3>
                  <p className='text-sm text-gray-600'>Beautiful, accessible UI components with Tailwind CSS</p>
                </div>
                <div className='p-4 border rounded-lg'>
                  <h3 className='font-semibold text-orange-600 mb-2'>✓ Framer Motion</h3>
                  <p className='text-sm text-gray-600'>Smooth animations and transitions for better user experience</p>
                </div>
                <div className='p-4 border rounded-lg'>
                  <h3 className='font-semibold text-red-600 mb-2'>✓ Toast Notifications</h3>
                  <p className='text-sm text-gray-600'>User feedback with beautiful toast notifications using Sonner</p>
                </div>
                <div className='p-4 border rounded-lg'>
                  <h3 className='font-semibold text-teal-600 mb-2'>✓ TypeScript</h3>
                  <p className='text-sm text-gray-600'>Full type safety throughout the application</p>
                </div>
              </div>
            </div>
          </FadeIn>
