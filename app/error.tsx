      ...
      >
        ...
        >
          ...
          <p className='body-medium-regular text-muted-foreground'>
            Ứng dụng đã gặp phải một lỗi bất ngờ. Chúng tôi đã ghi nhận sự cố này và sẽ khắc phục sớm nhất có thể.
          </p>
        </motion.div>
          ...
          >
            <div className='flex items-start space-x-3'>
              ...
              <div className='space-y-2'>
                <h3 className='body-small-semibold text-error'>Chi tiết lỗi (Development Mode):</h3>
                <p className='body-xsmall-regular text-error-200 font-mono break-all'>{error.message}</p>
                {error.digest && <p className='body-xsmall-regular text-error-200'>Error ID: {error.digest}</p>}
              </div>
            </div>
          </motion.div>
        )}
        ...
        >
          <Button onClick={reset} className='flex items-center space-x-2 min-w-[140px]' size='lg'>
