...
export const AUTH_STORAGE_KEYS = {
  ...
  hasParticipatedEntryTest: 'has-participated-entry-test'
} as const
...
export const setStoredHasParticipatedEntryTest = (value: boolean) => {
  if (typeof window === 'undefined') return
  localStorage.setItem(AUTH_STORAGE_KEYS.hasParticipatedEntryTest, value ? 'true' : 'false')
}

export const getStoredHasParticipatedEntryTest = (): boolean => {
  if (typeof window === 'undefined') return false
  return localStorage.getItem(AUTH_STORAGE_KEYS.hasParticipatedEntryTest) === 'true'
}

export const clearStoredHasParticipatedEntryTest = () => {
  if (typeof window === 'undefined') return
  localStorage.removeItem(AUTH_STORAGE_KEYS.hasParticipatedEntryTest)
}
