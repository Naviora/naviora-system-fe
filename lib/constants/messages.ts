...
export const ERROR_MESSAGES = {
  ...
  [ERROR_CODES.UNAUTHORIZED_ACCESS]: 'You are not authorized to access this resource.',
  [ERROR_CODES.INSUFFICIENT_PERMISSIONS]: 'You do not have sufficient permissions to perform this action.',
  ...
  [ERROR_CODES.INVALID_PASSWORD_FORMAT]: 'Password must meet the required format.',
  [ERROR_CODES.PASSWORD_TOO_WEAK]: 'Password is too weak. Please choose a stronger password.',
  [ERROR_CODES.PASSWORDS_DO_NOT_MATCH]: 'Passwords do not match. Please try again.',
  [ERROR_CODES.INVALID_INPUT_FORMAT]: 'Invalid input format. Please check your data.',
  [ERROR_CODES.VALUE_OUT_OF_RANGE]: 'Value is out of acceptable range.',

  // User Management Errors
  [ERROR_CODES.USER_NOT_FOUND]: 'User not found. Please check the user information.',
  [ERROR_CODES.USER_ALREADY_EXISTS]: 'A user with this information already exists.',
  [ERROR_CODES.EMAIL_ALREADY_IN_USE]: 'This email address is already in use. Please use a different email.',
  [ERROR_CODES.USERNAME_ALREADY_TAKEN]: 'This username is already taken. Please choose a different username.',
  [ERROR_CODES.USER_CREATION_FAILED]: 'Failed to create user. Please try again.',
  [ERROR_CODES.USER_UPDATE_FAILED]: 'Failed to update user information. Please try again.',
  [ERROR_CODES.USER_DELETION_FAILED]: 'Failed to delete user. Please try again.',
  ...
  [ERROR_CODES.RESOURCE_CREATION_FAILED]: 'Failed to create resource. Please try again.',
  [ERROR_CODES.RESOURCE_UPDATE_FAILED]: 'Failed to update resource. Please try again.',
  [ERROR_CODES.RESOURCE_DELETION_FAILED]: 'Failed to delete resource. Please try again.',
  [ERROR_CODES.RESOURCE_ACCESS_DENIED]: 'You do not have permission to access this resource.',

  // Database Errors
  [ERROR_CODES.DATABASE_CONNECTION_ERROR]: 'Unable to connect to database. Please try again later.',
  [ERROR_CODES.DATABASE_QUERY_ERROR]: 'Database query failed. Please try again.',
  [ERROR_CODES.DATABASE_CONSTRAINT_VIOLATION]: 'Operation violates database constraints.',
  [ERROR_CODES.DATABASE_TIMEOUT]: 'Database operation timed out. Please try again.',

  // File Upload Errors
  [ERROR_CODES.FILE_TOO_LARGE]: 'File is too large. Please choose a smaller file.',
  [ERROR_CODES.INVALID_FILE_TYPE]: 'Invalid file type. Please choose a different file.',
  ...
  [ERROR_CODES.RATE_LIMIT_EXCEEDED]: 'Rate limit exceeded. Please wait before trying again.',
  ...
  [ERROR_CODES.MAINTENANCE_MODE]: 'System is currently under maintenance. Please try again later.',
...
export const SUCCESS_MESSAGES = {
  ...
  [SUCCESS_CODES.REGISTRATION_SUCCESS]: 'Account created successfully. Welcome!',
...
export const getSuccessMessage = (successCode: keyof typeof SUCCESS_CODES): string => {
  return SUCCESS_MESSAGES[SUCCESS_CODES[successCode]] || 'Operation completed successfully.'
}
