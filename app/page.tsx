...
import {
  ...
  StaggerContainer,
  StaggerItem,
} from "@/components/animations/fade-slide-scale";
import {
  Zap,
  Shield,
  Palette,
        ...
        <FadeIn>
          <div className='text-center max-w-4xl mx-auto'>
            ...
            <p className='text-xl text-gray-600 mb-8 leading-relaxed'>
              A comprehensive, production-ready Next.js starter with modern
              tooling, beautiful UI components, and best practices baked in.
            </p>
          ...
          <div className='text-center mt-20'>
            <div className='bg-white rounded-2xl shadow-xl p-8 max-w-2xl mx-auto border'>
              ...
              <p className='text-gray-600 mb-6'>
                Get started with this boilerplate and ship your next project
                faster than ever.
              </p>
